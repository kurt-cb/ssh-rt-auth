...
def _ssh_pubkey_blob_from_ed25519(pubkey) -> bytes:
    ...
    key. Matches wrapper.python.enforce_listener._ssh_pubkey_blob_from_cert.
    """
...
def test_wrapper_enforce_end_to_end(request, tmp_path_factory):
    ...
    push_text(TARGET_NAME,
              ...
              'ExecStart=/usr/bin/python3 -m wrapper.python '
    ...
    r = lxc_exec(TARGET_NAME, 'sh', '-c',
                 f'cd /app && PYTHONPATH=/app python3 -m wrapper.python.mssh '
